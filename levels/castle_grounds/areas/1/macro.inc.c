...
const MacroObject castle_grounds_seg7_macro_objs[] = {
    ...
    MACRO_OBJECT               (/*preset*/ macro_red_coin,                  /*yaw*/   0, /*pos*/  -4400,  420,  4500),
	MACRO_OBJECT               (/*preset*/ macro_red_coin,                  /*yaw*/   0, /*pos*/  -6000,  490,  -2300),
	MACRO_OBJECT               (/*preset*/ macro_red_coin,                  /*yaw*/   0, /*pos*/  6500,  480,  -600),
	MACRO_OBJECT               (/*preset*/ macro_red_coin,                  /*yaw*/   0, /*pos*/  5500,  780,  -5300),
	MACRO_OBJECT               (/*preset*/ macro_red_coin,                  /*yaw*/   0, /*pos*/  -4700,  290,  900),
	MACRO_OBJECT               (/*preset*/ macro_red_coin,                  /*yaw*/   0, /*pos*/  1700,  70,  2500),
	MACRO_OBJECT               (/*preset*/ macro_red_coin,                  /*yaw*/   0, /*pos*/  0,   510, -1170),
	MACRO_OBJECT               (/*preset*/ macro_red_coin,                  /*yaw*/   0, /*pos*/  -1200,  340,  3300),
    MACRO_OBJECT_END(),
};
